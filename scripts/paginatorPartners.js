...
function updatePagination() {
    ...
    prevButton.innerHTML = `
        <button class="flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-transparent hover:bg-[#2d256c] hover:text-white transition duration-200" onclick="changePage(currentPage - 1)" ${currentPage === 1 ? 'disabled' : ''}>
    ...
    nextButton.innerHTML = `
        <button class="flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-transparent hover:bg-[#2d256c] hover:text-white transition duration-200" onclick="changePage(currentPage + 1)" ${currentPage === totalPages ? 'disabled' : ''}>
